...
export default async function AnalyticsV1Page() {
      ...
      <div className="flex-1 px-1 py-4 md:px-2 md:py-6 overflow-x-hidden w-full box-border">
        <div className="max-w-7xl mx-auto space-y-6 w-full overflow-x-hidden box-border">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold text-blue-900 mb-1">Analytics V1 (Legacy)</h3>
              <p className="text-xs text-blue-700">This is the original analytics page. Try the new version for improved visualizations.</p>
            </div>
            <Link 
              href="/en/analytics" 
