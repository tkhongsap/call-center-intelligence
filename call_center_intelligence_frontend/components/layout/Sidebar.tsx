...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 bg-card border-r border-default h-screen">
      {/* Logo */}
      ...
      <div className="px-4 py-2 mt-auto flex-shrink-0 flex items-center gap-2">
        <LanguageSwitcher upwards />
        {mounted && (
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full hover:bg-[var(--background-secondary)] transition-colors twitter-focus-ring"
      ...
      {/* User/Role Section */}
      <div className="px-2 py-3 border-t border-default">
