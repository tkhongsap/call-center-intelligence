...
class Upload(Base, CreatedAtMixin):
    ...
    status: Mapped[UploadStatus] = mapped_column(SQLEnum(UploadStatus, create_type=False), nullable=False, default=UploadStatus.processing)
    ...
    recompute_status: Mapped[Optional[RecomputeStatus]] = mapped_column(SQLEnum(RecomputeStatus, create_type=False), name="recompute_status")
