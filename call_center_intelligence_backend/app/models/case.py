...
class Case(Base, TimestampMixin):
    ...
    channel: Mapped[Channel] = mapped_column(SQLEnum(Channel, create_type=False), nullable=False)
    status: Mapped[CaseStatus] = mapped_column(SQLEnum(CaseStatus, create_type=False), nullable=False)
    category: Mapped[str] = mapped_column(String, nullable=False)
    sentiment: Mapped[Sentiment] = mapped_column(SQLEnum(Sentiment, create_type=False), nullable=False)
